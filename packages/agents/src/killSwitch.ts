 ...
 * there is no separate "auto kill" code path (spec Section 8). Shared
 * package (not inside apps/apex) so apps/web's admin dashboard can
 * call it directly without importing another app.
 */
