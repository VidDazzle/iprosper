...
export async function GET(request: NextRequest) {
  ...
  if (!parsed) return html("Link expired", "This approval link is invalid or has expired. Please review it in your X Debt portal.", false);
...
function html(title: string, body: string, ok: boolean): Response {
  ...
  return new Response(
    `<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title} · X Debt</title>
...
<body><div class="card"><div class="brand">X&nbsp;<span style="color:#8b5cf6">Debt</span></div>
