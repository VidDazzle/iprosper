...
/** Lets a signed-in client turn on push notifications for approvals & updates. */
  ...
  if (state === "on") {
    return (
      <div className="flex items-center gap-2 rounded-xl border border-emerald-400/20 bg-emerald-400/5 px-4 py-3 text-sm text-emerald-200">
        <BellRing className="h-4 w-4" /> Push notifications are on — we&rsquo;ll ping you the moment an action needs your approval.
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3">
      <div className="flex items-center gap-2 text-sm text-slate-300">
        ...
        Get pinged instantly when a settlement needs your approval.
      </div>
